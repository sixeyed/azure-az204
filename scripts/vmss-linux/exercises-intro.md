...
**Create a VM with cloud-init** - You'll see how to work with this step by step

**Use cloud-init for Linux VMSS** - You'll see how to work with this step by step

**Update VMSS** - You'll see how to work with this step by step
