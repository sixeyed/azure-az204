# Docker Multi - Hands-On Exercises Introduction

## Transition to Practical Work

Now that we've covered the concepts, let's put them into practice. In the upcoming exercises, you'll get hands-on experience working with docker multi.

## What You'll Do

In this hands-on session, we'll walk through several practical exercises:

**Simple Multi-Stage Build** - You'll see how to work with this step by step

**BuildKit and Build Targets** - You'll see how to work with this step by step

**Real Go Application** - You'll see how to work with this step by step

**Summary** - You'll see how to work with this step by step
